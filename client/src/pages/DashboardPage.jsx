...
import { faBell, faCalendar, faListAlt, faSave } from '@fortawesome/free-solid-svg-icons';
                    ...
                    <div className='container'>
                        <div className='mt-5 row row--content'>
                            <div className={`col mt-5 ${darkMode ? 'dark-mode' : ''}`} style={{ backgroundColor: 'white' }}>
                                ...
                                <p className='text-center'>Welcome to your dashboard. Here you can manage your notifications, posts, and saved posts.</p>
                                <div className='col mt-5 d-flex flex-wrap'>
                                    <div className='mt-3 col-12 col-md-4'>
                                        <Link to='/dashboard/allnotifications' style={{ textDecoration: 'none' }} 
                                    ...
                                    <div className='mt-3 col-12 col-md-4'>
                                        <Link to='/dashboard/allposts' style={{ textDecoration: 'none' }} 
                                        className={`card rounded-lg p-4 shadow d-flex align-items-center ${darkMode ? 'dark-mode' : ''}`}>
                                    ...
                                    <div className='mt-3 col-12 col-md-4'>
                                        <Link to='/dashboard/allsaveposts' style={{ textDecoration: 'none' }} 
                                        className={`card rounded-lg p-4 shadow d-flex align-items-center ${darkMode ? 'dark-mode' : ''}`}>
                                            <FontAwesomeIcon icon={faSave} color='green' size='3x' className='mr-4' />
                                            <div className='card-body text-center'>
