...
import { faCheckCircle, faCloudUploadAlt, faEllipsisVertical, faFilePdf, faListAlt, faTimes } from '@fortawesome/free-solid-svg-icons';
...
export default function AdminAllPostsPage() {
    ...
    const handleUpdateSubmit = async(e) => {
        ...
        try {
            ...
            const response = await axios.put(`/post/update-post-admin/${selectedPostId}`, formDataToSend, {
                headers: {
    ...
    const handleDeletePost = async(postId) => {
        try {
            const response = await axios.delete(`/post/delete-post-admin/${postId}`);
            if(response.data.error){
                toast.error(response.data.error);
            }else{
                toast.success(response.data.message);
