...
export default function SidebarNormalScreen({ showModal, handleLogoutConfirmation, handleCloseModal, handleConfirmLogout }) {
  ...
  return (
    <div className='pt-3'>
        ...
        <div className='mt-3'>
            <hr className={`${darkMode ? 'dark-mode-sidebar-border' : ''}`} style={{ borderTop: '1px solid black' }} /> 
